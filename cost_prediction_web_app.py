# -*- coding: utf-8 -*-
"""
Created on Wed Oct 19 00:14:00 2022
...
def main():
    ...
    Length = st.text_input('Enter Number of Length')
    Transactions = st.text_input('Enter Number of Transaction')
    Entities = st.text_input('Enter the Number of Entities')
    PointsNonAdjust = st.text_input('Enter the Number of PointsNonAdjust')
    PointsAdjust = st.text_input('Enter the Number of PointsAdjust')
